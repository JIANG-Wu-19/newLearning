...
![1732439232371](image/note/1732439232371.png)

默认5s刷新一次，ctrl+c退出

top前五行内容详解

![1732438657987](image/note/1732438657987.png)

![1732438680363](image/note/1732438680363.png)

top命令内容详解

![1732438854050](image/note/1732438854050.png)
...
* RES进程使用物理内存
* SHR进程使用共享内存
* S进程状态（S休眠，R运行，Z僵状态，N负数优先级，I空闲状态）
* %CPU进程占用CPU率
* %MEM进程占用内存率
* TIME+进程使用CPU时间总计
* COMMMAND进程的命令或名称或程序文件路径

top交互式选项

当交互式运行时，可以用以下交互式命令进行控制

![1732439417194](image/note/1732439417194.png)

![1732439491343](image/note/1732439491343.png)
...
![1732440428037](image/note/1732440428037.png)
...
![1732440624560](image/note/1732440624560.png)

![1732440681423](image/note/1732440681423.png)
...
![1732440868244](image/note/1732440868244.png)

![1732441327711](image/note/1732441327711.png)

### 环境变量

![1732445777209](image/note/1732445777209.png)

![1732445824643](image/note/1732445824643.png)
